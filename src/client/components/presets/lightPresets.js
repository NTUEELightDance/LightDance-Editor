...
function LightPresets() {
    ...
    const { lightPresets: loadedLightPresets } = (0, react_redux_1.useSelector)(loadSlice_1.selectLoad);
    const { lightPresets } = (0, react_redux_1.useSelector)(globalSlice_1.selectGlobal);
    (0, react_1.useEffect)(() => {
        if ((0, localStorage_1.getItem)("lightPresets")) {
            dispatch((0, globalSlice_1.setLightPresets)(JSON.parse((0, localStorage_1.getItem)("lightPresets"))));
        }
        else {
            dispatch((0, globalSlice_1.setLightPresets)(loadedLightPresets));
        }
    }, []);
    // dialog
    ...
    const handleAddPresets = (name) => {
        if (name.trim() !== "")
            dispatch((0, globalSlice_1.addLightPresets)(name));
        closeDialog();
    };
    const handleEditPresets = (name, idx) => {
        dispatch((0, globalSlice_1.editLightPresetsName)({ name, idx }));
        closeDialog();
    };
    const handleDeletePresets = (idx) => {
        dispatch((0, globalSlice_1.deleteLightPresets)(idx));
    };
    const handleSetCurrentStatus = (status) => {
        dispatch((0, globalSlice_1.setCurrentStatus)(status));
    };
    ...
    return (react_1.default.createElement("div", null,
        react_1.default.createElement("div", { style: { padding: 8 } },
            ...
            react_1.default.createElement(presetsList_1.default, { presets: lightPresets, handleEditPresets: handleEditPresets, handleDeletePresets: handleDeletePresets, handleSetCurrent: handleSetCurrentStatus })),
