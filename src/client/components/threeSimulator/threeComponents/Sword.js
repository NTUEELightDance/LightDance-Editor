...
class ThreeSword {
  ...
  addModel2Scene(position) {
    ...
    const initModel = (gltf) => {
      ...
      // guardMesh.material.color.setHex(0x000000);
      // guardMesh.material.emissive.setHex(0x284895);
      // guardMesh.material.emissiveIntensity = 0.7;
      // this.parts.GUARD = guardMesh;
    ...
    loader.load("data/models/sword.gltf", initModel.bind(this));
  }
