        ...
        <div>
            <List>
                            ...
                            <ListItem
                                secondaryAction={
                                    <IconButton edge="end" aria-label="apply">
                                        <AddIcon onClick={() => handleOpenApply(key)} sx={{ color: "white" }} />
                                    </IconButton>
                                }
                ...
                <Grid
                    ...
                    sx={{ width: "100%", minHeight: "80px", justifyContent: "center", alignItems: "center" }}
                >
            ...
            <Dialog open={applyOpened} sx={{ color: "white", backgroundColor: "black" }}>
