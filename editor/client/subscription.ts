                ...
                client.cache.modify({
                    ...
                    fields: {
                        positionFrameIDs(positionFrameIDs: Array<string>) {
                            const { index, addID, updateID, deleteID } = data.data.positionRecordSubscription;
                ...
                client.cache.modify({
                    ...
                    fields: {
                        controlFrameIDs(controlFrameIDs: Array<string>) {
                            const { index, addID, updateID, deleteID } = data.data.controlRecordSubscription;
                ...
                client.cache.modify({
                    ...
                    fields: {
                        ControlMap(controlMap) {
                            const { createFrames, deleteFrames, updateFrames } = data.data.controlMapSubscription.frame;
