...
from ....utils.convert import control_map_to_animation_data, rgba_to_float
            ...
            if part_type == PartType.LED:
                for led_obj in part_obj.children:
                    ...
                    for d in range(3):
                        ...
                        for i, (frame_start, fade, led_rgb_float) in enumerate(frames):
                ...
                for d in range(3):
                    ...
                    _, kpoints_list = get_keyframe_points(curve)
                    for i, (frame_start, fade, fiber_rgb_float) in enumerate(frames):
                        point = kpoints_list[i]
