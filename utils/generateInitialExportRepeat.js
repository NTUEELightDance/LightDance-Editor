...
(async () => {
  ...
  for (let i = 0; i < 240; i++) {
    controlData[5*i] = generateEmptyControlFrame(dancerData, 0 + 5000 * i, BLACK, ALL_BLACK);
    controlData[5*i+1] = generateEmptyControlFrame(dancerData, 1000 + 5000 * i, WHITE, ALL_WHITE);
    controlData[5*i+2] = generateEmptyControlFrame(dancerData, 2000 + 5000 * i, RED, ALL_RED);
    controlData[5*i+3] = generateEmptyControlFrame(dancerData, 3000 + 5000 * i, GREEN, ALL_GREEN);
    controlData[5*i+4] = generateEmptyControlFrame(dancerData, 4000 + 5000 * i, BLUE, ALL_BLUE);
  }
