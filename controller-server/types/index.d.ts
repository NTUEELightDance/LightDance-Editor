...
interface dancerClientDic { [key: string]: DancerSocket }
interface controlPanelClientDic { [key: string]: ControlPanelSocket }
...
export { LightStatusType, PlayTimeType, PayloadType, dancerClientDic, controlPanelClientDic, SocketMes, Dic, clientsAgent }