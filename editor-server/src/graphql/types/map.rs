...
use crate::{graphql::types::control_data::RedisControlMandatory, types::global::RedisPosition};
...
#[derive(Serialize, Deserialize)]
pub struct ControlMapScalar(pub HashMap<String, RedisControlMandatory>);
