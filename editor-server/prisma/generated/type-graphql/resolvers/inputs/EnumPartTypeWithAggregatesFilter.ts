...
import { NestedEnumPartTypeWithAggregatesFilter } from "../inputs/NestedEnumPartTypeWithAggregatesFilter";
import { NestedIntFilter } from "../inputs/NestedIntFilter";
import { PartType } from "../../enums/PartType";

@TypeGraphQL.InputType("EnumPartTypeWithAggregatesFilter", {
  isAbstract: true
})
export class EnumPartTypeWithAggregatesFilter {
